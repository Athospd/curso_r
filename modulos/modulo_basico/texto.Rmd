...
Cuidado! Numa sentença `if {...} else {...}`, você não pode pular uma linha para colocar o `else`, após o `}`. A explicação dessa característica do R tem tudo a ver com a ideia de que, no R, todos os objetos são funções.
